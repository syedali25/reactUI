...
!(function (n) {
  ...
  function r(t, e) {
    return (
      a[e] || (a[e] = new RegExp(Ct(e), "g")),
      "string" == typeof t && "." !== e
        ? t.replace(/\./g, "").replace(a[e], ".")
        : t
    );
  }
  function o(t, e, n) {
  ...
  function n(t, e, n) {
    return (
      !!h(t) ||
      ((h((a = t)) || "string" == typeof a) && !!o(g(t), e, n)) ||
      null
    );
    var a;
  }
  ...
  var p,
    ...
    w = function (y) {
      (this.$ = function (t, e) {
        ...
        (this.api = function (t) {
          return new ge(t ? oe(this[p.iApiIndex]) : this);
        }),
        (this.fnAddData = function (t, e) {
          var n = this.api(!0),
            t = (
              Array.isArray(t) && (Array.isArray(t[0]) || j.isPlainObject(t[0]))
                ? n.rows
                : n.row
            ).add(t);
        ...
        (this.fnDeleteRow = function (t, e, n) {
          var a = this.api(!0),
            ...
            t = o.aoData[r[0][0]];
          return (
            r.remove(), e && e.call(this, o, t), (n !== N && !n) || a.draw(), t
          );
        }),
        ...
        this.each(function () {
          ...
          if ("table" == this.nodeName.toLowerCase()) {
            I(e),
              F(e.column),
              x(e, e, !0),
              x(e.column, e.column, !0),
              x(e, j.extend(r, l.data()), !0);
            ...
            (f.nTable = this),
              ...
              (f.oInit = r),
              n.push(f),
              (f.oInstance = 1 === D.length ? D : l.dataTable()),
              I(r),
              A(r.oLanguage),
              r.aLengthMenu &&
                !r.iDisplayLength &&
              ...
              le(f.oLanguage, r, "fnInfoCallback"),
              ce(f, "aoDrawCallback", r.fnDrawCallback, "user"),
              ce(f, "aoServerParams", r.fnServerParams, "user"),
              ce(f, "aoStateSaveParams", r.fnStateSaveParams, "user"),
              ce(f, "aoStateLoadParams", r.fnStateLoadParams, "user"),
              ce(f, "aoStateLoaded", r.fnStateLoaded, "user"),
              ce(f, "aoRowCallback", r.fnRowCallback, "user"),
              ce(f, "aoRowCreatedCallback", r.fnCreatedRow, "user"),
              ce(f, "aoHeaderCallback", r.fnHeaderCallback, "user"),
              ce(f, "aoFooterCallback", r.fnFooterCallback, "user"),
              ce(f, "aoInitComplete", r.fnInitComplete, "user"),
              ce(f, "aoPreDrawCallback", r.fnPreDrawCallback, "user"),
              (f.rowIdFn = Y(r.rowId)),
              L(f);
            var d = f.oClasses;
            j.extend(d, w.ext.classes, r.oClasses),
              l.addClass(d.sTable),
              f.iInitDisplayStart === N &&
                ((f.iInitDisplayStart = r.iDisplayStart),
                (f._iDisplayStart = r.iDisplayStart)),
              null !== r.iDeferLoading &&
                ((f.bDeferLoading = !0),
                (p = Array.isArray(r.iDeferLoading)),
                (f._iRecordsDisplay = p ? r.iDeferLoading[0] : r.iDeferLoading),
                (f._iRecordsTotal = p ? r.iDeferLoading[1] : r.iDeferLoading));
            var h = f.oLanguage;
            j.extend(!0, h, r.oLanguage),
              h.sUrl
                ? (j.ajax({
                    dataType: "json",
                    url: h.sUrl,
            ...
            var p = f.asStripeClasses,
              g = l.children("tbody").find("tr").eq(0);
            -1 !==
              j.inArray(
                !0,
                j.map(p, function (t, e) {
                  return g.hasClass(t);
                })
              ) &&
              (j("tbody tr", this).removeClass(p.join(" ")),
              (f.asDestroyStripes = p.slice()));
            var b,
              m,
              S = [],
              p = this.getElementsByTagName("thead");
            if (
              (0 !== p.length && (ct(f.aoHeader, p[0]), (S = ft(f))),
              null === r.aoColumns)
            )
              for (b = [], o = 0, s = S.length; o < s; o++) b.push(null);
            else b = r.aoColumns;
            for (o = 0, s = b.length; o < s; o++) R(f, S ? S[o] : null);
            U(f, r.aoColumnDefs, b, function (t, e) {
              P(f, t, e);
            }),
              g.length &&
                ((m = function (t, e) {
                ...
                j(g[0])
                  ...
                  .each(function (t, e) {
                    var n,
                      a = f.aoColumns[t];
                    a.mData === t &&
                      ((n = m(e, "sort") || m(e, "order")),
                      (e = m(e, "filter") || m(e, "search")),
                      (null === n && null === e) ||
                        ((a.mData = {
                          _: t + ".display",
              ...
              p = function () {
                if (r.aaSorting === N) {
                  ...
                  for (o = 0, s = t.length; o < s; o++)
                    t[o][1] = f.aoColumns[o].asSorting[0];
                }
                ee(f),
                  v.bSort &&
                ...
                var e = l.children("caption").each(function () {
                  ...
                  n = l.children("thead");
                0 === n.length && (n = j("<thead/>").appendTo(l)),
                  (f.nTHead = n[0]);
                var a = l.children("tbody");
                0 === a.length && (a = j("<tbody/>").insertAfter(n)),
                  (f.nTBody = a[0]);
                a = l.children("tfoot");
                if (
                  (0 ===
                    (a =
                      ...
                      ("" !== f.oScroll.sX || "" !== f.oScroll.sY)
                        ? j("<tfoot/>").appendTo(l)
                        : a).length || 0 === a.children().length
                    ? l.addClass(d.sNoFooter)
                    : 0 < a.length &&
                      ((f.nTFoot = a[0]), ct(f.aoFooter, f.nTFoot)),
                  r.aaData)
                )
                  for (o = 0; o < r.aaData.length; o++) V(f, r.aaData[o]);
                else
                  (!f.bDeferLoading && "dom" != pe(f)) ||
                    X(f, j(f.nTBody).children("tr"));
                (f.aiDisplay = f.aiDisplayMaster.slice()),
                  !(f.bInitialised = !0) === i && Pt(f);
              };
            r.bStateSave
              ? ((v.bStateSave = !0),
                ce(f, "aoDrawCallback", ae, "state_save"),
                re(f, 0, p))
              : p();
    ...
    v = function (t, e) {
      if (Array.isArray(e)) for (var n = 0; n < e.length; n++) v(t, e[n]);
      else t.push(e);
      return t;
    };
  function D(n) {
    ...
    n._hungarianMap || D(n),
      j.each(a, function (t, e) {
        (o = n._hungarianMap[t]) === N ||
          (!r && a[o] !== N) ||
          ("o" === o.charAt(0)
            ? (a[o] || (a[o] = {}), j.extend(!0, a[o], a[t]), x(n[o], a[o], r))
            : (a[o] = a[t]));
      });
  }
  function A(t) {
  ...
  function I(t) {
    _(t, "ordering", "bSort"),
      _(t, "orderMulti", "bSortMulti"),
      _(t, "orderClasses", "bSortClasses"),
      _(t, "orderCellsTop", "bSortCellsTop"),
      _(t, "order", "aaSorting"),
      _(t, "orderFixed", "aaSortingFixed"),
      _(t, "paging", "bPaginate"),
      _(t, "pagingType", "sPaginationType"),
      _(t, "pageLength", "iDisplayLength"),
      _(t, "searching", "bFilter"),
      "boolean" == typeof t.sScrollX && (t.sScrollX = t.sScrollX ? "100%" : ""),
      "boolean" == typeof t.scrollX && (t.scrollX = t.scrollX ? "100%" : "");
    var e = t.aoSearchCols;
    if (e)
      for (var n = 0, a = e.length; n < a; n++)
        e[n] && x(w.models.oSearch, e[n]);
  }
  function F(t) {
    _(t, "orderable", "bSortable"),
      _(t, "orderData", "aDataSort"),
      _(t, "orderSequence", "asSorting"),
      _(t, "orderDataType", "sortDataType");
    var e = t.aDataSort;
  ...
  function L(t) {
    ...
    w.__browser ||
      ...
      n.remove()),
      j.extend(t.oBrowser, w.__browser),
  ...
  function P(t, e, n) {
    ...
    a.sWidthOrig ||
      ...
      (e = (o.attr("style") || "").match(/width:\s*(\d+[pxem%]+)/)) &&
        (a.sWidthOrig = e[1])),
      n !== N &&
        null !== n &&
        (F(n),
        x(w.defaults.column, n, !0),
        ...
        j.extend(a, n),
        le(a, n, "sWidth", "sWidthOrig"),
        n.iDataSort !== N && (a.aDataSort = [n.iDataSort]),
        le(a, n, "aDataSort"));
    var i = a.mData,
      l = Y(i),
    ...
    (a._bAttrSrc =
      j.isPlainObject(i) && (n(i.sort) || n(i.type) || n(i.filter))),
      (a._setter = null),
      ...
      t.oFeatures.bSort || ((a.bSortable = !1), o.addClass(r.sSortableNone));
    (t = -1 !== j.inArray("asc", a.asSorting)),
      (o = -1 !== j.inArray("desc", a.asSorting));
    a.bSortable && (t || o)
      ? t && !o
        ? ((a.sSortingClass = r.sSortableAsc),
          (a.sSortingClassJUI = r.sSortJUIAscAllowed))
        : !t && o
        ? ((a.sSortingClass = r.sSortableDesc),
          (a.sSortingClassJUI = r.sSortJUIDescAllowed))
        : ((a.sSortingClass = r.sSortable), (a.sSortingClassJUI = r.sSortJUI))
      : ((a.sSortingClass = r.sSortableNone), (a.sSortingClassJUI = ""));
  }
  function O(t) {
  ...
  function W(t) {
    var n = 0;
    return (
      j.each(t.aoColumns, function (t, e) {
  ...
  function E(t, n) {
    var a = [];
    return (
      j.map(t.aoColumns, function (t, e) {
        t[n] && a.push(e);
      }),
      a
    );
  ...
  function U(t, e, n, a) {
    ...
    if (e)
      for (r = e.length - 1; 0 <= r; r--)
        for (
          var u,
            c = (u = e[r]).targets !== N ? u.targets : u.aTargets,
            f = 0,
  ...
  function V(t, e, n, a) {
    ...
    return (
      e !== N && (t.aIds[e] = o),
      (!n && t.oFeatures.bDeferRender) || at(t, r, n, a),
      r
    );
  }
  function X(n, t) {
    var a;
    return (t = !(t instanceof j) ? j(t) : t).map(function (t, e) {
  ...
  function Z(a) {
    ...
    var d = function (t, e, n) {
      for (
        var a, r, o, i, l = z(n), n = l[l.length - 1], s = 0, u = l.length - 1;
        s < u;
        s++
      ) {
  ...
  function nt(t, e, n, a) {
    ...
    function d(t, e) {
      ...
      "string" != typeof t ||
        (-1 !== (n = t.indexOf("@")) &&
          ((n = t.substring(n + 1)), Z(t)(a, e.getAttribute(n))));
    }
    function h(t) {
      (n !== N && n !== u) ||
        ((o = c[u]),
        ...
        o && o._bAttrSrc
          ? (Z(o.mData._)(a, i),
            ...
            d(o.mData.filter, t))
          : f
          ? (o._setter || (o._setter = Z(o.mData)), o._setter(a, i))
          : (a[u] = i)),
        u++;
    }
    if (s)
    ...
    return (
      !e || ((e = e.getAttribute("id")) && Z(t.rowId)(a, e)),
      { data: a, cells: l }
    );
  }
  function at(t, e, n, a) {
    ...
    if (null === c.nTr) {
      for (
        ...
        (i = t.aoColumns[l]),
          ...
          (!u &&
            ((!i.mRender && i.mData === l) ||
              (j.isPlainObject(i.mData) && i.mData._ === l + ".display"))) ||
            (o.innerHTML = J(t, e, l, "display")),
          i.sClass && (o.className += " " + i.sClass),
          i.bVisible && !n
            ? r.appendChild(o)
            : !i.bVisible && n && o.parentNode.removeChild(o),
          i.fnCreatedCell &&
            i.fnCreatedCell.call(t.oInstance, o, J(t, e, l), f, e, l);
  ...
  function rt(t, e) {
    ...
    n &&
      ...
      a.DT_RowClass &&
        ...
        (e.__rowc = e.__rowc ? b(e.__rowc.concat(t)) : t),
        j(n).removeClass(e.__rowc.join(" ")).addClass(a.DT_RowClass)),
      a.DT_RowAttr && j(n).attr(a.DT_RowAttr),
      a.DT_RowData && j(n).data(a.DT_RowData));
  }
  function ot(t) {
    var e,
      n,
      ...
      l = t.oClasses,
      s = t.aoColumns;
    for (i && (n = j("<tr/>").appendTo(r)), c = 0, f = s.length; c < f; c++)
      (a = s[c]),
        (e = j(a.nTh).addClass(a.sClass)),
        i && e.appendTo(n),
        t.oFeatures.bSort &&
          (e.addClass(a.sSortingClass),
          !1 !== a.bSortable &&
    ...
    if (
      (i && ct(t.aoHeader, r),
      j(r).children("tr").attr("role", "row"),
      j(r).children("tr").children("th, td").addClass(l.sHeaderTH),
      j(o).children("tr").children("th, td").addClass(l.sFooterTH),
      null !== o)
    )
      for (var u = t.aoFooter[0], c = 0, f = u.length; c < f; c++)
        ((a = s[c]).nTf = u[c].cell), a.sClass && j(a.nTf).addClass(a.sClass);
  }
  function it(t, e, n) {
    var a,
      r,
  ...
  function lt(t, e) {
    ...
    if (-1 === j.inArray(!1, n)) {
      ...
      (t.bDrawing = !0),
        s !== N &&
          -1 !== s &&
          ((t._iDisplayStart = !u && s >= t.fnRecordsDisplay() ? 0 : s),
          (t.iInitDisplayStart = -1));
      (n = t._iDisplayStart), (s = t.fnDisplayEnd());
      if (t.bDeferLoading) (t.bDeferLoading = !1), t.iDraw++, Wt(t, !1);
      else if (u) {
        if (!t.bDestroying && !e) return void ht(t);
      } else t.iDraw++;
      if (0 !== c.length)
        for (var f = u ? t.aoData.length : s, d = u ? 0 : n; d < f; d++) {
          var h = c[d],
            p = t.aoData[h];
          null === p.nTr && at(t, h);
          var g,
          ...
          0 !== i &&
            ((g = o[r % i]),
            p._sRowStripe != g &&
              (j(b).removeClass(p._sRowStripe).addClass(g),
              (p._sRowStripe = g))),
            fe(t, "aoRowCallback", null, [b, p._aData, r, d, h]),
            a.push(b),
            r++;
        }
      else {
        ...
        1 == t.iDraw && "ajax" == pe(t)
          ? (u = l.sLoadingRecords)
          : l.sEmptyTable && 0 === t.fnRecordsTotal() && (u = l.sEmptyTable),
          (a[0] = j("<tr/>", { class: i ? o[0] : "" }).append(
            j("<td />", {
              valign: "top",
              colSpan: W(t),
      ...
      fe(t, "aoHeaderCallback", "header", [
        j(t.nTHead).children("tr")[0],
        K(t),
        n,
        s,
        c,
      ]),
        fe(t, "aoFooterCallback", "footer", [
          j(t.nTFoot).children("tr")[0],
          K(t),
          n,
          s,
          c,
  ...
  function st(t, e) {
    var n = t.oFeatures,
      ...
      n = n.bFilter;
    a && Zt(t),
      n ? St(t, t.oPreviousSearch) : (t.aiDisplay = t.aiDisplayMaster.slice()),
  ...
  function ut(t) {
    ...
    for (
      var o, i, l, s, u, c, f, d = t.sDom.split(""), h = 0;
      h < d.length;
      h++
    ) {
      if (((o = null), "<" == (i = d[h]))) {
        if (((f = j("<div/>")[0]), "'" == (l = d[h + 1]) || '"' == l)) {
          ...
          "H" == s ? (s = e.sJUIHeader) : "F" == s && (s = e.sJUIFooter),
            -1 != s.indexOf(".")
              ? ((c = s.split(".")),
                (f.id = c[0].substr(1, c[0].length - 1)),
                (f.className = c[1]))
              : "#" == s.charAt(0)
              ? (f.id = s.substr(1, s.length - 1))
              : (f.className = s),
            (h += u);
        }
        r.append(f), (r = j(f));
  ...
  function dt(r, t, e) {
    var a, o;
    fe(r, "aoServerParams", "serverParams", [t]),
      t &&
        Array.isArray(t) &&
        ((a = {}),
        (o = /(.*?)\[\]$/),
    ...
    j.isPlainObject(l) &&
      ...
      (t = "function" == typeof i && u ? u : j.extend(!0, t, u)),
      delete l.data);
    var u = {
      data: t,
      success: function (t) {
      ...
      error: function (t, e, n) {
        ...
        -1 === j.inArray(!0, a) &&
          ("parsererror" == e
            ? ie(r, 0, "Invalid JSON response", 1)
            : 4 === t.readyState && ie(r, 0, "Ajax error", 7)),
          Wt(r, !1);
      },
    };
    (r.oAjaxData = t),
      fe(r, null, "preXhr", [r, t]),
      r.fnServerData
        ? r.fnServerData.call(
            s,
            r.sAjaxSource,
            j.map(t, function (t, e) {
        ...
        ? (r.jqXHR = j.ajax(j.extend(u, { url: l || r.sAjaxSource })))
        : "function" == typeof l
        ? (r.jqXHR = l.call(s, t, n, r))
        : ((r.jqXHR = j.ajax(j.extend(u, l))), (l.data = i));
  }
  function ht(e) {
    e.iDraw++,
      Wt(e, !0),
      dt(e, pt(e), function (t) {
        gt(e, t);
      });
  }
  function pt(t) {
    ...
    for (
      ...
      (a = o[g]),
        (r = u[g]),
        (e = "function" == typeof a.mData ? "function" : a.mData),
        p.columns.push({
          data: e,
          name: a.sName,
        ...
        n("mDataProp_" + g, e),
        l.bFilter &&
          (n("sSearch_" + g, r.sSearch),
          n("bRegex_" + g, r.bRegex),
          n("bSearchable_" + g, a.bSearchable)),
        l.bSort && n("bSortable_" + g, a.bSortable);
    l.bFilter && (n("sSearch", s.sSearch), n("bRegex", s.bRegex)),
      l.bSort &&
        (j.each(f, function (t, e) {
  ...
  function gt(t, n) {
    ...
    (t.aiDisplay = t.aiDisplayMaster.slice()),
      lt(t, !0),
      t._bInitComplete || jt(t, n),
      Wt(t, !1);
  }
  function bt(t, e) {
    t =
      j.isPlainObject(t.ajax) && t.ajax.dataSrc !== N
        ? t.ajax.dataSrc
        : t.sAjaxDataProp;
  ...
  function mt(n) {
    ...
    var t = n.oClasses,
      ...
      u = j("input", t)
        ...
        .on("keyup.DT search.DT input.DT paste.DT cut.DT", s ? Jt(e, s) : e)
    ...
    return (
      j(n.nTable).on("search.dt.DT", function (t, e) {
        if (n === e)
          try {
  ...
  function St(t, e, n) {
    ...
    var o = t.oPreviousSearch,
      i = t.aoPreSearchCols;
    if ((B(t), "ssp" != pe(t))) {
      Dt(t, e.sSearch, n, r(e), e.bSmart, e.bCaseInsensitive), a(e);
      for (var l = 0; l < i.length; l++)
        yt(t, i[l].sSearch, l, r(i[l]), i[l].bSmart, i[l].bCaseInsensitive);
      vt(t);
    } else a(e);
  ...
  function yt(t, e, n, a, r, o) {
    if ("" !== e) {
      for (
        var i, l = [], s = t.aiDisplay, u = _t(e, a, r, o), c = 0;
        c < s.length;
        c++
      )
  ...
  function Dt(t, e, n, a, r, o) {
    var i,
      ...
      r = t.aiDisplayMaster,
      c = [];
    if ((0 !== w.ext.search.length && (n = !0), (o = xt(t)), e.length <= 0))
      t.aiDisplay = r.slice();
    else {
      for (
        (o ||
        ...
        s.test(t.aoData[i[l]]._sFilterRow) && c.push(i[l]);
      t.aiDisplay = c;
    }
  }
  function _t(t, e, n, a) {
  ...
  function xt(t) {
    for (
      ...
      if (!(i = t.aoData[c])._aFilterData) {
        for (r = [], n = 0, a = l.length; n < a; n++)
          (e = l[n]).bSearchable
            ? ((o = J(t, c, n, "filter")),
              "string" !=
                typeof (o =
                  null === (o = s[e.sType] ? s[e.sType](o) : o) ? "" : o) &&
                o.toString &&
                (o = o.toString()))
            : (o = ""),
            o.indexOf &&
              -1 !== o.indexOf("&") &&
              ((Tt.innerHTML = o), (o = wt ? Tt.textContent : Tt.innerText)),
  ...
  function Ft(t) {
    var e = t.sTableId,
      n = t.aanFeatures.i,
      a = j("<div/>", { class: t.oClasses.sInfo, id: n ? null : e + "_info" });
    return (
      n ||
        (t.aoDrawCallback.push({ fn: Lt, sName: "information" }),
        a.attr("role", "status").attr("aria-live", "polite"),
        j(t.nTable).attr("aria-describedby", e + "_info")),
      a[0]
    );
  }
  function Lt(t) {
          ...
          fn: function (t) {
            if (d)
              for (
                ...
                he(t, "pageButton")(t, h.p[s], s, l, o, i);
            else f.fnUpdate(t, c);
          },
          sName: "pagination",
        })),
  ...
  function kt(t, e, n) {
    ...
    return (
      (t._iDisplayStart = a), e && (fe(t, null, "page", [t]), n && lt(t)), e
    );
  }
  function Mt(t) {
    return j("<div/>", {
  ...
  function Wt(t, e) {
    t.oFeatures.bProcessing &&
      j(t.aanFeatures.r).css("display", e ? "block" : "none"),
      fe(t, null, "processing", [t, e]);
  }
  function Et(t) {
    var e = j(t.nTable);
    e.attr("role", "grid");
    ...
    var r = n.sX,
      ...
      d = "<div/>";
    f.length || (f = null);
    u = j(d, { class: i.sScrollWrapper })
      .append(
        j(d, { class: i.sScrollHead })
          .css({
            overflow: "hidden",
            position: "relative",
            border: 0,
      ...
      .append(
        j(d, { class: i.sScrollBody })
          .css({ position: "relative", overflow: "auto", width: a(r) })
          .append(e)
      );
    f &&
      u.append(
        j(d, { class: i.sScrollFoot })
          .css({ overflow: "hidden", border: 0, width: r ? a(r) : "100%" })
          .append(
            j(d, { class: i.sScrollFootInner }).append(
              c
                .removeAttr("id")
                .css("margin-left", 0)
    ...
    return (
      r &&
        j(e).on("scroll.DT", function (t) {
          var e = this.scrollLeft;
          (h.scrollLeft = e), f && (p.scrollLeft = e);
        }),
      j(e).css("max-height", o),
      n.bCollapse || j(e).css("height", o),
      (t.nScrollHead = h),
      (t.nScrollBody = e),
      (t.nScrollFoot = p),
      t.aoDrawCallback.push({ fn: Bt, sName: "scrolling" }),
      u[0]
    );
  }
  function Bt(n) {
    ...
    if (n.scrollBarVis !== h && n.scrollBarVis !== N)
      return (n.scrollBarVis = h), void O(n);
    (n.scrollBarVis = h),
      _.children("thead, tfoot").remove(),
      w &&
        ((a = w.clone().prependTo(_)), (t = w.find("tr")), (e = a.find("tr"))),
      (h = D.clone().prependTo(_)),
      (a = D.find("tr")),
      (D = h.find("tr")),
      h.find("th, td").removeAttr("tabindex"),
      l || ((S.width = "100%"), (f[0].style.width = "100%")),
      j.each(ft(n, h), function (t, e) {
      ...
      "" === l
        ? ((T.width = "100%"),
          A &&
            (_.find("tbody").height() > b.offsetHeight ||
              "scroll" == m.css("overflow-y")) &&
            (T.width = zt(_.outerWidth() - c)),
          (h = _.outerWidth()))
        : "" !== s && ((T.width = zt(s)), (h = _.outerWidth())),
      Ut(i, D),
      Ut(function (t) {
      ...
      _.outerWidth() < h
        ? ((o =
            b.scrollHeight > b.offsetHeight || "scroll" == m.css("overflow-y")
              ? h + c
              : h),
          A &&
            (b.scrollHeight > b.offsetHeight ||
              "scroll" == m.css("overflow-y")) &&
            (T.width = zt(o - c)),
          ("" !== l && "" === s) || ie(n, 1, "Possible column misalignment", 6))
        : (o = "100%"),
      (S.width = zt(o)),
      (d.width = zt(o)),
      w && (n.nScrollFoot.style.width = zt(o)),
      u || (A && (S.height = zt(C.offsetHeight + c)));
    C = _.outerWidth();
    (g[0].style.width = zt(C)), (p.width = zt(C));
    (g = _.height() > b.clientHeight || "scroll" == m.css("overflow-y")),
      (x = "padding" + (x.bScrollbarLeft ? "Left" : "Right"));
    (p[x] = g ? c + "px" : "0px"),
      w &&
        ((y[0].style.width = zt(C)),
        (v[0].style.width = zt(C)),
        (v[0].style[x] = g ? c + "px" : "0px")),
  ...
  function Xt(t) {
    var e,
      ...
      b = g.bScrollOversize,
      m = a.style.width;
    for (m && -1 !== m.indexOf("%") && (d = m), D = 0; D < c.length; D++)
      null !== (e = r[c[D]]).sWidth &&
        ((e.sWidth = qt(e.sWidthOrig, h)), (p = !0));
    if (b || (!p && !l && !i && u == W(t) && u == f.length))
      for (D = 0; D < u; D++) {
        var S = k(t, D);
        null !== S && (r[S].sWidth = zt(f.eq(D).width()));
      }
    else {
      ...
      for (
        o.find("thead, tfoot").remove(),
          o.append(j(t.nTHead).clone()).append(j(t.nTFoot).clone()),
          o.find("tfoot th, tfoot td").css("width", ""),
          f = ft(t, o.find("thead")[0]),
          D = 0;
        D < c.length;
        D++
      )
      ...
      if (t.aoData.length)
        for (D = 0; D < c.length; D++)
          (e = r[(n = c[D])]),
            j(Gt(t, n)).clone(!1).append(e.sContentPadding).appendTo(v);
      ...
      l && s
        ...
        ? (o.css("width", "auto"),
          o.removeAttr("width"),
          o.width() < h.clientWidth && d && o.width(h.clientWidth))
        : i
        ? o.width(h.clientWidth)
        : d && o.width(d);
      for (var y = 0, D = 0; D < c.length; D++) {
        var _ = j(f[D]),
          C = _.outerWidth() - _.width(),
          _ = g.bBounding
            ? Math.ceil(f[D].getBoundingClientRect().width)
            : _.outerWidth();
        (y += _), (r[c[D]].sWidth = zt(_ - C));
      }
      (a.style.width = zt(y)), m.remove();
    }
    d && (a.style.width = zt(d)),
      (!d && !l) ||
        t._reszEvt ||
        ((d = function () {
          j(T).on(
  ...
  function $t(t, e) {
    for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
      (n = (n = (n = J(t, o, e, "display") + "").replace(Vt, "")).replace(
        /&nbsp;/g,
        " "
    ...
    for (
      ...
      for (r = (o = c[(s = h[n][(a = 0)])].aDataSort).length; a < r; a++)
        (l = c[(i = o[a])].sType || "string"),
          h[n]._idx === N && (h[n]._idx = j.inArray(h[n][1], c[i].asSorting)),
          u.push({
            src: s,
            col: i,
            dir: h[n][1],
  ...
  function Zt(t) {
    var e,
      ...
      o = (t.aoColumns, 0),
      i = t.aiDisplayMaster;
    for (B(t), e = 0, n = (c = Yt(t)).length; e < n; e++)
  ...
  function Qt(t, e, n, a) {
    var r,
      ...
      o = function (t, e) {
        var n = t._idx;
        return (n = n === N ? j.inArray(t[1], l) : n) + 1 < l.length
          ? n + 1
          : e
          ? null
          : 0;
    ...
    "number" == typeof i[0] && (i = t.aaSorting = [i]),
      n && t.oFeatures.bSortMulti
        ? -1 !== (n = j.inArray(e, H(i, "0")))
          ? null === (r = null === (r = o(i[n], !0)) && 1 === i.length ? 0 : r)
            ? i.splice(n, 1)
            : ((i[n][1] = l[r]), (i[n]._idx = r))
          : (i.push([e, l[0], 0]), (i[i.length - 1]._idx = 0))
        : i.length && i[0][0] == e
        ? ((r = o(i[0])), (i.length = 1), (i[0][1] = l[r]), (i[0]._idx = r))
        : ((i.length = 0), i.push([e, l[0]]), (i[0]._idx = 0)),
      st(t),
  ...
  function ee(t) {
    ...
    if (l.bSort && l.bSortClasses) {
      for (e = 0, n = r.length; e < n; e++)
        (a = r[e].src),
          j(H(t.aoData, "anCells", a)).removeClass(o + (e < 2 ? e + 1 : 3));
      for (e = 0, n = i.length; e < n; e++)
        (a = i[e].src),
          j(H(t.aoData, "anCells", a)).addClass(o + (e < 2 ? e + 1 : 3));
    }
    t.aLastSort = i;
  }
  function ne(t, e) {
    ...
    for (
      var l = w.ext.type.order[o.sType + "-pre"], s = 0, u = t.aoData.length;
      s < u;
      s++
    )
  ...
  function ae(n) {
    ...
    n.oFeatures.bStateSave &&
      ...
      fe(n, "aoStateSaveParams", "stateSaveParams", [n, t]),
      (n.oSavedState = t),
  ...
  function re(a, t, r) {
      ...
      if (t && t.time) {
        ...
        if (-1 === j.inArray(!1, e)) {
          ...
          if (0 < e && t.time < +new Date() - 1e3 * e) r();
            ...
            if (
              ((a.oLoadedState = j.extend(!0, {}, t)),
              t.start !== N &&
                ((a._iDisplayStart = t.start), (a.iInitDisplayStart = t.start)),
              t.length !== N && (a._iDisplayLength = t.length),
              t.order !== N &&
                ((a.aaSorting = []),
                j.each(t.order, function (t, e) {
                  a.aaSorting.push(e[0] >= l.length ? [0, e[1]] : e);
                })),
              t.search !== N && j.extend(a.oPreviousSearch, It(t.search)),
              t.columns)
            )
              for (o = 0, i = t.columns.length; o < i; o++) {
                var n = t.columns[o];
                n.visible !== N && (l[o].bVisible = n.visible),
                  n.search !== N &&
                    j.extend(a.aoPreSearchCols[o], It(n.search));
              }
    ...
    a.oFeatures.bStateSave
      ? (n = a.fnStateLoadCallback.call(a.oInstance, a, e)) !== N && e(n)
      : r();
  }
  function oe(t) {
    var e = w.settings,
  ...
  function se(t, e, n) {
    ...
    for (r in e)
      e.hasOwnProperty(r) &&
        ((a = e[r]),
        j.isPlainObject(a)
          ? (j.isPlainObject(t[r]) || (t[r] = {}), j.extend(!0, t[r], a))
  ...
  function fe(n, t, e, a) {
    ...
    return (
      t &&
        (r = j.map(n[t].slice().reverse(), function (t, e) {
          return t.fn.apply(n.oInstance, a);
        })),
      null !== e &&
        ((e = j.Event(e + ".dt")), j(n.nTable).trigger(e, a), r.push(e.result)),
      r
    );
  }
  function de(t) {
  ...
  function he(t, e) {
    var n = t.renderer,
      t = w.ext.renderer[e];
    return j.isPlainObject(n) && n[e]
      ? t[n[e]] || t._
      : ("string" == typeof n && t[n]) || t._;
  }
  function pe(t) {
  ...
  (w.Api = ge =
    function (t, e) {
      if (!(this instanceof ge)) return new ge(t, e);
      function n(t) {
        var e,
          n,
          a,
    ...
    j.extend(ge.prototype, {
      ...
      eq: function (t) {
        var e = this.context;
        return e.length > t ? new ge(e[t], this[t]) : null;
      },
      filter: function (t) {
        var e = [];
        ...
        return new ge(this.context, e);
      },
      flatten: function () {
        var t = [];
        return new ge(this.context, t.concat.apply(t, this.toArray()));
      },
      join: me.join,
      indexOf:
        me.indexOf ||
      ...
      iterator: function (t, e, n, a) {
        ...
        if (d.length || a) {
          (a = new ge(h, t ? d.concat.apply([], d) : d)), (t = a.selector);
      ...
      unique: function () {
        return new ge(this.context, b(this));
      },
      unshift: me.unshift,
    }),
    (ge.extend = function (t, e, n) {
      if (n.length && e && (e instanceof ge || e.__dt_wrapper))
        for (var a, r = 0, o = n.length; r < o; r++)
          (e[(a = n[r]).name] =
            "function" === a.type
              ? (function (e, n, a) {
                  return function () {
                    ...
                    return ge.extend(t, t, a.methodExt), t;
                  };
                })(t, a.val, a)
              : "object" === a.type
              ? {}
            ...
            ge.extend(t, e[a.name], a.propExt);
    }),
    (ge.register = e =
      function (t, e) {
        if (Array.isArray(t))
          for (var n = 0, a = t.length; n < a; n++) ge.register(t[n], e);
        else
          for (var r = t.split("."), o = be, i = 0, l = r.length; i < l; i++) {
            var s,
              u,
              c = (function (t, e) {
  ...
  e("tables()", function (t) {
    return t !== N && null !== t ? new ge(Se(t, this.context)) : this;
  }),
    e("table()", function (t) {
      var e = this.tables(t),
        t = e.context;
      return t.length ? new ge(t[0]) : e;
    }),
    ...
    e("draw()", function (e) {
      return this.iterator("table", function (t) {
        "page" === e
          ? lt(t)
          : st(t, !1 === (e = "string" == typeof e ? "full-hold" !== e : e));
      });
    }),
    e("page()", function (e) {
      return e === N
  ...
  function De(t) {
    return (
      ...
      j.extend({ search: "none", order: "current", page: "all" }, t)
    );
  }
  function _e(t) {
  ...
  var Ce = function (t, e) {
    var n,
      ...
      l = e.order,
      e = e.page;
    if ("ssp" == pe(t)) return "removed" === i ? [] : d(0, o.length);
    if ("current" == e)
      ...
      for (u = 0, c = t.aoData.length; u < c; u++)
        ("none" == i ||
          (-1 === (n = j.inArray(u, r)) && "removed" == i) ||
          (0 <= n && "applied" == i)) &&
          a.push(u);
    return a;
  };
  e("rows()", function (e, n) {
    e === N ? (e = "") : j.isPlainObject(e) && ((n = e), (e = "")), (n = De(n));
    var t = this.iterator(
      "table",
      function (t) {
        return ye(
          ...
          function (n) {
            ...
            if (((l = l || Ce(o, i)), null !== t && -1 !== j.inArray(t, l)))
              return [t];
            if (null === n || n === N || "" === n) return l;
            if ("function" == typeof n)
              return j.map(l, function (t) {
                var e = a[t];
            ...
            if (n.nodeName) {
              ...
              if (t)
                return a[t.row] && a[t.row].nTr === n.parentNode ? [t.row] : [];
    ...
    e("row().data()", function (t) {
      ...
      return (
        (n._aData = t),
        Array.isArray(t) && n.nTr && n.nTr.id && Z(e[0].rowId)(t, n.nTr.id),
        et(e[0], this[0], "data"),
        this
      );
    }),
  ...
  function Te(t, e) {
    var n = t.context;
    !n.length ||
      ((t = n[0].aoData[e !== N ? e : t[0]]) &&
        t._details &&
        (t._details.remove(), (t._detailsShow = N), (t._details = N)));
  }
  function we(t, e) {
    var n = t.context;
    n.length &&
      t.length &&
      (t = n[0].aoData[t[0]])._details &&
      ((t._detailsShow = e)
      ...
      r.off(e + " " + n + " " + t),
        0 < H(u, "_details").length &&
          ...
          r.on(n, function (t, e, n, a) {
            if (s === e)
              for (var r, o = W(e), i = 0, l = u.length; i < l; i++)
                (r = u[i])._details &&
            ...
            (l = function (t, e) {
              ...
              if (Array.isArray(t) || t instanceof j)
                ...
                t.nodeName && "tr" === t.nodeName.toLowerCase()
                  ? i.push(t)
                  : ((n = j("<tr><td></td></tr>").addClass(e)),
                    (j("td", n).addClass(e).html(t)[0].colSpan = W(o)),
                    i.push(n[0]));
            })(t, e),
  ...
  e("columns()", function (n, a) {
    n === N ? (n = "") : j.isPlainObject(n) && ((a = n), (n = "")), (a = De(a));
    var t = this.iterator(
      "table",
      function (t) {
        return (
            ...
            function (n) {
              ...
              if ("function" == typeof n) {
                ...
                return j.map(s, function (t, e) {
                  return n(e, Fe(i, e, 0, 0, a), c[e]) ? e : null;
                });
              }
          ...
          return n === N
            ...
            : void (function (t, e, n) {
                ...
                if (i.bVisible !== n) {
                  if (n)
                    for (
                      var s = j.inArray(!0, H(o, "bVisible"), e + 1),
                        u = 0,
                        c = l.length;
                      u < c;
                      u++
        ...
        n !== N &&
          this.iterator("table", function (t) {
            it(t, t.aoHeader),
              it(t, t.aoFooter),
              t.aiDisplay.length ||
                j(t.nTBody).find("td[colspan]").attr("colspan", W(t)),
              ae(t),
  ...
  e("cells()", function (g, t, b) {
          ...
          ye(
            ...
            function (t) {
                ...
                for (o = [], i = 0, l = d.length; i < l; i++)
                  for (r = d[i], s = 0; s < p; s++)
                    (u = { row: r, column: s }),
                      e
                        ? ((c = f[r]),
                          t(u, J(a, r, s), c.anCells ? c.anCells[s] : null) &&
                            o.push(u))
                        : o.push(u);
                return o;
              }
              ...
              return n.length || !t.nodeName
                ? n
                : (c = j(t).closest("*[data-dt-row]")).length
    ...
    return j.extend(e.selector, { cols: t, rows: g, opts: b }), e;
  }),
    ...
    (w.isDataTable = w.fnIsDataTable =
      function (t) {
        ...
        return (
          t instanceof w.Api ||
          (j.each(w.settings, function (t, e) {
    ...
    e("destroy()", function (f) {
      return (
        ...
        this.iterator("table", function (e) {
          ...
          (e.bDestroying = !0),
            fe(e, "aoDestroyCallback", "destroy", [e]),
            f || new ge(e).columns().visible(!0),
            c.off(".DT").find(":not(tbody *)").off(".DT"),
            j(T).off(".DT-" + e.sInstance),
            ...
            (e.aaSortingFixed = []),
            ee(e),
            j(o).removeClass(e.asStripeClasses.join(" ")),
            j("th, td", i).removeClass(
              a.sSortable +
                " " +
                a.sSortableAsc +
                " " +
  ...
  function Pe(t, e) {
    ...
    return (
      e <= a
        ? (n = d(0, e))
        : t <= r
        ? ((n = d(0, a - 2)).push("ellipsis"), n.push(e - 1))
        : (e - 1 - r <= t
            ? (n = d(e - (a - 2), e)).splice(0, 0, "ellipsis")
            : ((n = d(t - r + 2, t + r - 1)).push("ellipsis"),
              n.push(e - 1),
  ...
  j.extend(Re, {
    ...
    j.extend(!0, w.ext.renderer, {
      pageButton: {
        _: function (u, t, c, e, f, d) {
            ...
            v = function (t, e) {
              for (
                ...
                if (((n = e[i]), Array.isArray(n))) {
                  var s = j("<" + (n.DT_el || "div") + "/>").appendTo(t);
                  v(s, n);
                } else {
                  switch (((h = null), (p = n), (a = u.iTabIndex), n)) {
                    case "ellipsis":
                      t.append('<span class="ellipsis">&#x2026;</span>');
                      break;
                    case "first":
                      (h = b.sFirst), 0 === f && ((a = -1), (p += " " + r));
                      break;
                    case "previous":
                      (h = b.sPrevious), 0 === f && ((a = -1), (p += " " + r));
                      break;
                    case "next":
                      (h = b.sNext),
                        (0 !== d && f !== d - 1) || ((a = -1), (p += " " + r));
                    ...
                    case "last":
                      ...
                      break;
                    default:
                      (h = u.fnFormatNumber(n + 1)),
                        (p = f === n ? g.sPageButtonActive : "");
                  }
                  null !== h &&
                    (ue(
                      j("<a>", {
          ...
          try {
            n = j(t).find(y.activeElement).data("dt-idx");
          } catch (t) {}
          v(j(t).empty(), e),
            n !== N &&
              j(t)
    ...
    j.extend(w.ext.type.detect, [
      function (t, e) {
        e = e.oLanguage.sDecimal;
        return o(t, e) ? "num" + e : null;
      },
      function (t, e) {
    ...
    j.extend(w.ext.type.search, {
      ...
      string: function (t) {
        return !h(t) && "string" == typeof t ? t.replace(i, " ") : t;
      },
    });
      ...
      header: {
        ...
        jqueryui: function (r, o, i, l) {
          j("<div/>")
            ...
            .append(o.contents())
            .append(
              j("<span/>").addClass(l.sSortIcon + " " + i.sSortingClassJUI)
            )
            .appendTo(o),
            j(r.nTable).on("order.dt.DT", function (t, e, n, a) {
              r === e &&
  ...
  function Oe(e) {
    return function () {
      var t = [oe(this[w.ext.iApiIndex])].concat(
  ...
  return (
    ...
    (((j.fn.dataTable = w).$ = j).fn.dataTableSettings = w.settings),
    (j.fn.dataTableExt = w.ext),
    (j.fn.DataTable = function (t) {
